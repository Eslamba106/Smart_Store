...
Route::controller(ProductController::class)->group(function () {
    Route::get('products','index')->middleware('auth:admin')->name('admin.products.index');
...
Route::controller(BrandController::class)->group(function () {
    Route::get('brands','index')->middleware('auth:admin')->name('admin.brands.index');
    Route::post('brands/store','store')->middleware('auth:admin')->name('admin.brands.store');
    Route::get('brands/create','create')->middleware('auth:admin')->name('admin.brands.create');
    Route::get('brands/show/{id}','show')->middleware('auth:admin')->name('admin.brands.show');
    Route::get('brands/edit/{brands}','edit')->middleware('auth:admin')->name('admin.brands.edit');
    Route::put('brands/update/{id}','update')->middleware('auth:admin')->name('admin.brands.update');
    Route::delete('brands/delete/{id}','delete')->middleware('auth:admin')->name('admin.brands.delete');
});
